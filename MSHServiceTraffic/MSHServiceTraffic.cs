...
namespace MSHService
{
    ...
    public partial class MSHServiceTraffic : UserControl, MSHService
    {
        private string DefaultLocation;
        private string IniFilePath;

        public MSHServiceTraffic()
        {
        ...
        {
            return P_Semantics["dictionnaire"].Value.ToString();
        }
